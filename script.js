document.addEventListener("DOMContentLoaded", () => {
  ...
  // Student Modal Logic
  const addStudentFabBtn = document.querySelector('.fab[title="Add Student"]');
  ...
  const submitStudentBtn = document.getElementById("submit-student");
  const studentNameInput = document.getElementById("student-name");
  const studentFathersNameInput = document.getElementById(
  ...
  addStudentFabBtn.addEventListener("click", () => {
  ...
  submitStudentBtn.addEventListener("click", () => {
    const name = studentNameInput.value.trim();
    const fathersName = studentFathersNameInput.value.trim();
    const mobile = studentMobileInput.value.trim();
    const monthlyFee = studentMonthlyFeeInput.value.trim();
    const batch = studentBatchInput.value.trim();
    ...
    if (name) {
      ...
      // Here you would typically add logic to save the student
      closeStudentModal();
    } else {
  ...
  editButtons.forEach((btn) => {
    btn.addEventListener("click", (e) => {
      ...
      // Here you can add logic to open an edit modal or form
    });
  });
